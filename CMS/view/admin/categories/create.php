...
<nav class="navbar  navbar-light bg-gradiant-green-blue nav-shadow">
    ...
    <a class="navbar-brand" href="http://localhost/www/CMS/admin">Admin panel</a>
    <span class="">
        <a class="text-decoration-none px-3 text-dark" href="http://localhost/www/CMS/comment"><i class="fas fa-comments"></i></a>
            <span class="dropdown">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <section class="row my-3">
                <section class="col-12">
                    <form method="post" action="http://localhost/www/CMS/category/store">
